...
<img alt="Icon" width=100 src="./common/src/main/resources/assets/herenthere/icon.png">
...
[![Available on Modrinth](https://img.shields.io/modrinth/dt/CdTnUpve?label=Available%20on%20Modrinth&logo=modrinth&logoColor=%2300AF5C)](https://modrinth.com/project/CdTnUpve)
[![Available on CurseForge](https://img.shields.io/curseforge/dt/1293136?label=Available%20on%20CurseForge&logo=curseforge)](https://curseforge.com/minecraft/mc-mods/herenthere)
[![Available on GitHub](https://img.shields.io/github/downloads/TerminalMC/HereNThere/total?label=Available%20on%20GitHub&logo=github&logoColor=white)](https://github.com/TerminalMC/HereNThere)
...
HereNThere uses a placeholder system, so in addition to the basic aliases enabled by default, you
can add aliases for a range of other values. Currently, the following placeholders are available:
...
- `%pos%`
  ...
  - The full pattern allows for variations, all of which can be combined:
    ...
    - `%pos^1.3^^-2%` - alters the position according to the caret modifiers (distance left, up and
      forwards relative to the player's facing angle).
- `%x%`
...
- `%facing%`
  - The angle that the player is facing, as a 3D decimal vector of magnitude `1` e.g.
    `-0.092361,-0.489725,-0.866971`.
  - The full pattern allows for variations, all of which can be combined:
...
[![Issues](https://img.shields.io/github/issues/TerminalMC/HereNThere?logo=github&label=GitHub%20Issues)](https://github.com/TerminalMC/HereNThere/issues)

[![License](https://img.shields.io/github/license/TerminalMC/HereNThere?label=License&logo=github&logoColor=white)](https://github.com/TerminalMC/HereNThere/blob/HEAD/LICENSE.txt)
